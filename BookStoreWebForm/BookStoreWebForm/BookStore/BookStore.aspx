...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
        <script  src="../Scripts/WebForms/ToolTip.js" type="text/javascript" ></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="bookcount" >
     ...
     <asp:Repeater ID="RepeatInformation"     runat="server">  
           ...
           <ItemTemplate> 
                ...
                <div class="card cardFlex1 cards" data-toggle="tooltip" data-placement="right" data-container="body" <%--data-mdb-toggle="tooltip"--%> title="<%#DataBinder.Eval(Container,"DataItem.Description")%>" style=" margin: 10px;  height: 330px; width: 18rem;">
  ...
  <div class="card-body ">
    ...
    <p class="card-text" style="position:absolute; bottom:73px"><%#DataBinder.Eval(Container,"DataItem.AuthorName")%> </p>
       ...
       <%--<span class="card-text tooltiptext" style="position:absolute; bottom:73px"><%#DataBinder.Eval(Container,"DataItem.Description")%> </span>--%>
